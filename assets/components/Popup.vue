<template>
    <div class="wrapper">
        ...
        <div class="buttons">
            <button type="button" class="state-off" @click="setActive(false)" :class="{'is-active': !active}">Off</button>
            <button type="button" class="state-on" @click="setActive(true)" :class="{'is-active': active}">On</button>
        </div>
        <div class="sites">
